...
from model import BertMultiNoAlignmentModel
...
model = BertMultiNoAlignmentModel(hp).to(device)
print("BertMultiNoAlignmentModel model have {} paramerters in total".format(sum(x.numel() for x in model.parameters())))
