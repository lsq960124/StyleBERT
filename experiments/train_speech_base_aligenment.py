...
from model import BertMultiSpeechBaseAligenmentModel
...
model = BertMultiSpeechBaseAligenmentModel(hp).to(device)
print("BertMultiSpeechBaseAligenmentModel model have {} paramerters in total".format(sum(x.numel() for x in model.parameters())))
