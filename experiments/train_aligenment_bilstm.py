...
from model import BertMultiAligenmentBilstmModel
...
model = BertMultiAligenmentBilstmModel(hp).to(device)
print("BertMultiAligenmentBilstmModel model have {} paramerters in total".format(sum(x.numel() for x in model.parameters())))
