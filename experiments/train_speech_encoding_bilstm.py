...
from model import BertMultiSpeechEncodingBilstmModel
...
model = BertMultiSpeechEncodingBilstmModel(hp).to(device)
print("BertMultiSpeechEncodingBilstmModel model have {} paramerters in total".format(sum(x.numel() for x in model.parameters())))
