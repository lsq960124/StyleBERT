...
from model import BertMultiNoDiffProdModel
...
model = BertMultiNoDiffProdModel(hp).to(device)
print("BertMultiNoDiffProdModel model have {} paramerters in total".format(sum(x.numel() for x in model.parameters())))
