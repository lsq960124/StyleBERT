...
from model import BertMultiPoolModel
...
model = BertMultiPoolModel(hp).to(device)
print("BertMultiPoolModel model have {} paramerters in total".format(sum(x.numel() for x in model.parameters())))
